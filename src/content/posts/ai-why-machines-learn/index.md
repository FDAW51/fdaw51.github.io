...
updated: 2025-04-19
description: "《Why Machines Learn》第一章读书笔记：从动物模式识别出发，介绍感知机（Perceptron）、线性回归、神经元作为逻辑门的数学建模，以及「从错误中学习」的核心机器学习理念。"
tags: ["Perceptron", "Linear Regression", "Neuron as Logic Gate", "Learning from Mistakes", "Machine Learning"]
category: 机器学习
draft: false
---
...
- [[Perceptron]] — 感知机：Rosenblatt 1958 年的早期人工神经元模型，通过错误反馈学习分类
- [[Linear Regression]] — 线性回归：从数据中学习变量间线性关系的基础 ML 方法
- [[Neuron as Logic Gate]] — 神经元作为逻辑门：通过阈值 $\theta$ 实现 AND/OR 布尔运算
- [[Learning from Mistakes]] — 从错误中学习：感知机每次错误识别时通过反馈调整的核心学习理念

> 这些概念在 [[topics/Machine Learning and Neural Computation]] 主题中有更系统的梳理。
