...
description: "从量子力学薛定谔方程出发，逐步推演紧束缚模型、Bloch 定理、k·p 微扰理论，建立理解拓扑物态能带理论所需的完整数学框架。"
tags: ["Bloch Theorem", "Tight Binding Model", "k·p Perturbation", "SSH Model", "Brillouin Zone", "Effective Mass", "Topological State"]
category: 凝聚态物理/拓扑
draft: false
---
...
- [[Tight Binding Model]] — 电子在原子轨道间跳跃的紧束缚近似模型
- [[Bloch Theorem]] — 周期势中电子波函数的 Bloch 形式与能带结构
- [[Brillouin Zone]] — 倒空间中的 Wigner-Seitz 原胞，晶体动量基本域
- [[k·p Perturbation Theory]] — 高对称点附近能带的微扰展开方法
- [[Effective Mass]] — 晶体周期势中电子的表观质量，k·p 理论的核心结果
- [[SSH Model]] — 最简单的 1D 拓扑绝缘体模型，二聚化原子链
- [[Topological State]] — 由拓扑不变量而非对称性破缺表征的量子物态

> 这些概念是进入拓扑物态（拓扑绝缘体、拓扑超导体）研究的数学基础。
