---
title: "毕业论文｜Chapter 2 — Bell 不等式与 CHSH 博弈"
published: 2025-04-16
updated: 2025-04-16
description: "毕业论文第二章：推导 Bell 不等式的数学形式，证明量子力学违反局域实在论，并通过 CHSH 博弈论视角直观展示量子非局域性。"
tags: ["Bell Inequality", "CHSH Game", "Quantum Entanglement", "Hidden Variable Theory"]
category: 量子计算
draft: false
---
...
- [[Bell Inequality]] — 证明任何局域隐变量理论与量子力学不相容的数学不等式
- [[CHSH Game]] — Bell 定理的博弈论表述：经典胜率 75% vs 量子胜率 85%
- [[Quantum Entanglement]] — 量子非局域关联，Bell 不等式的物理基础
- [[Hidden Variable Theory]] — 被 Bell 定理证伪的局域隐变量尝试

> 前情见 Chapter 1 — [[EPR Paradox]] 的起源。应用见 Chapter 3 — [[Shor Algorithm]]。
