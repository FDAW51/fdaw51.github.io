---
title: "毕业论文｜Chapter 3 — Shor 算法"
published: 2025-05-09
updated: 2025-05-09
description: "毕业论文第三章：完整推导 Shor 算法的数学原理——量子傅立叶变换、量子相位估计，以及如何利用量子纠缠对大数分解实现指数级加速，威胁 RSA 加密。"
tags: ["Shor Algorithm", "Quantum Phase Estimation", "Quantum Fourier Transform", "Quantum Entanglement", "RSA"]
category: 量子计算
draft: false
---
...
$$
  ...
  由于抽屉原理，当我们有足够多的小球，那么就一定存在$i,j \in \R\text{ and } i <j$，使得：
$$
...
- [[Shor Algorithm]] — 大数分解的量子多项式时间算法 $O((\log n)^3)$，威胁 RSA 加密
- [[Quantum Phase Estimation]] — 估计酉算符本征值相位的量子子程序，Shor 算法的核心
- [[Quantum Fourier Transform]] — 量子傅立叶变换，指数级优于经典 FFT
- [[Quantum Entanglement]] — 量子纠缠的关联性是 Shor 算法实现指数加速的物理基础

> 理论前情见 Chapter 1 — [[EPR Paradox]] 与 Chapter 2 — [[Bell Inequality]]。
